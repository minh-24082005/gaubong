                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dien_thoai" class="form-control"
                                        value="{{ $user['dien_thoai'] ?? '' }}" maxlength="20">
                                </div>
                                <div class="form-group">
                                    <label for="dia_chi">Địa chỉ</label>
                                    <input type="text" name="dia_chi" class="form-control"
                                        value="{{ $user['dia_chi'] ?? '' }}" maxlength="255">
                                </div>
                                <div class="form-group">
                                    <label for="thanhpho">Thành phố</label>
                                    <input type="text" name="thanhpho" class="form-control"
                                        value="{{ $user['thanhpho'] ?? '' }}" maxlength="100">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="client" {{ ($user['type'] ?? '') == 'client' ? 'selected' : '' }}>Khách
                                            hàng</option>
                                    </select>
                                </div>
